        ...
        <div className="dashboard_container">
            ...
            <main>
                <div className="todo_manage_search">
                    <TextField fullWidth label="Search Task" sx={inputStyle}
                        value={search}
                    ...
                    <TextField
                        ...
                        fullWidth select label="Category" sx={inputStyle}>
                    ...
                    <TextField
                        ...
                        fullWidth select label="Priority" sx={inputStyle}>
                        <MenuItem value="">ALL</MenuItem>
                            ...
                            searchFilter.map((todo, index) => (
                                ...
                                >
                                    ...
                                    <div className="todo_action">
                                        ...
                                        <motion.div whileHover={{ scale: 1.2 }}>
                                            <Button onClick={() => handleDeleteTAsk(todo._id)} className="delete_btn">
                                                <Delete />
                                            </Button>
                                        </motion.div>
                                    </div>
